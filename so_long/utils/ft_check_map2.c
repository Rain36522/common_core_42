...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/01 15:54:59 by pudry             #+#    #+#             */
/*   Updated: 2023/11/02 18:36:21 by pudry            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (old_line[0] != '1' && (old_line[isize - 2] == '1' || \
		old_line[isize - 1] == '1'))
...
{
	if (map[j][i - 1] != '1' && map[j][i - 1] != 'P')
	{
		map[j][i - 1] = 'P';
		return (1);			
	}
	else if (map[j + 1][i] != '1' && map[j + 1][i] != 'P')
	{
		map[j + 1][i] = 'P';
		return (1);			
	}
